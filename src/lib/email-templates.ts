...
export const DEFAULT_EMAIL_TEMPLATES: Omit<EmailTemplate, 'id' | 'company_id' | 'created_at' | 'updated_at'>[] = [
  {
    ...
    is_active: true,
    language: 'en',
    preview_text: 'Welcome to our amazing community! We are excited to have you join us.',
    usage_priority: 5,
  ...
  },
  {
    ...
    is_active: true,
    language: 'en',
    preview_text: 'Quick check-in to see how you are doing and if you need any support.',
    usage_priority: 3,
    target_audience: 'customer',
    is_quick_action: false,
  },
  {
    ...
    is_active: true,
    language: 'en',
    preview_text: 'Thank you for your time today! Here are the next steps we discussed.',
    usage_priority: 4,
    target_audience: 'customer',
    is_quick_action: false,
  },
  {
    ...
    is_active: true,
    language: 'en',
    preview_text: 'You are invited to our exclusive training session. Don\'t miss out!',
    usage_priority: 6,
  ...
  },
  {
    ...
    is_active: true,
    language: 'en',
    preview_text: 'One week check-in to continue your journey and provide ongoing support.',
    usage_priority: 2,
    target_audience: 'customer',
    is_quick_action: false,
  },
