...
export default function ContactsPage() {
  ...
  // If environment is not configured, show setup message
  if (!isEnvConfigured) {
    return (
      <DashboardLayout>
          ...
          <div className="flex items-center justify-center p-8 min-h-[400px]">
            <div className="text-center max-w-lg">
              ...
              <p className="text-gray-600 mb-6">
                To run this application locally, you need to configure your Supabase environment variables.
              </p>
              
              <div className="bg-gray-50 rounded-lg p-6 mb-6 text-left">
                <h3 className="font-semibold text-gray-700 mb-3">Create .env.local file with:</h3>
...
NEXT_PUBLIC_APP_NAME=Network Marketing CRM`}
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <button
                  ...
                  className="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent text-sm font-medium rounded-md text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors"
                >
                  Reload Page
                </button>
              </div>
